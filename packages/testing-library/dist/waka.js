...
const waka_1 = __importStar(require("@ynn/waka"));
function createContext(request, response) {
    return new waka_1.Context({
        request: {
            url: '/',
            method: 'GET',
            ...request
...
function createApp(options) {
    return new waka_1.default(options);
}
exports.createApp = createApp;
;
async function createAppWithRequest(options, context) {
    const app = options instanceof waka_1.default ? options : createApp(options);
