...
export declare function createDecoratorException<T extends unknown[]>( method: MethodException<T>, options?: Readonly<CreateDecoratorExceptionOptions> ): MethodDecorator & ClassDecorator;
