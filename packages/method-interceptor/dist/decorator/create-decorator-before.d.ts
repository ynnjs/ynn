...
export declare function createDecoratorBefore<T extends unknown[]>( method: MethodBefore<T>, options?: Readonly<CreateDecoratorBeforeOptions> ): MethodDecorator & ClassDecorator;
