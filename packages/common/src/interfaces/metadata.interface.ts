...
import { MetadataBefore, MixedMatadataParameter, MetadataAfter, MetadataException } from '@ynn/method-interceptor';
...
export type ParameterMetadata<T = unknown> = MixedMatadataParameter<T>;
