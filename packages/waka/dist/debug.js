...
class Debug {
    ...
    static verbose(style, ...args) {
        this.print(style && { ...styles.verbose, ...style }, ...args);
    }
    log(...args) {
    ...
    verbose(...args) {
        __classPrivateFieldGet(this, _call).call(this, 'verbose', __classPrivateFieldGet(this, _styles) && __classPrivateFieldGet(this, _styles).verbose, ...args);
    }
}
