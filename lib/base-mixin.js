    ...
    return class extends Base {
        ...
        construct() {
            return Sequence.all( [
                ...
                () => is.function( this.init ) ? this.init() : true,
                () => {
                    const getPrototypeOf = Object.getPrototypeOf;
                    const getOwnPropertyNames = Object.getOwnPropertyNames;
                    ...
                    for( const property of properties( this ) ) {
                         ...
                         * because this[ property ] will execute the getter properties
                         */
                        if( /^init.+/.test( property ) && is.function( this[ property ] ) ) {
                            promises.push( this[ property ]() );
                        }
                    }
                ...
                () => is.function( this.afterinit ) ? this.afterinit() : true,
                () => {
                    this.isReady = true;
                    this[ BASE_RESOLVE ]( this );
                }
            ] ).catch( res => {
