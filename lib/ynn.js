    ...
    [ INIT_PLUGINS ]() {
        ...
        for( const name in plugins ) {
            ...
            try {
                ...
                if( m.autoinit !== false ) {
                    if( is.class( m.plugin ) ) {
                        plugin.instance = new m.plugin( this, plugin.options );
                    } else if( is.function( m.plugin ) ) {
                        this.console.info( m.plugin );
                        plugin.instance = m.plugin( this, plugin.options );
                    } else {
                        m.autoexec = false;
                    }
                }
                ...
                if( m.autoexec === false ) {
                    this[ name ] = plugin.instance = m.plugin;
                }
            } catch( e ) {
